                    ...
                    <div className='card'>
                        <div className="card-header bg-dark p-3">
                            <div className='card-header-flex'>
                                ...
                                {
                                    carts.length > 0 ?
                                        <button className='btn btn-danger mt-0 btn-sm' onClick={emptycart}><i className='fa fa-trash-alt mr-2'></i><span>EmptyCart</span></button>
                                        :
                                        ""
                                }
                            </div>
                        ...
                        <div className='card-body p-0'>
                            {
                                ...
                                <table className='table cart-table mb-0 table-responsive-sm'>
                                    ...
                                    <tbody>
                                        {
                                            carts.map((data,index)=>{ return(
                                                <Fragment key={index}>
                                                    <tr>
                                                        <td><button className='prdct-delete' onClick={()=>handleDecrement(data.id) }><i className='fa fa-trash-alt' ></i></button>
                                                        </td>
                                                        <td>
                                                            <div className='product-img'><img src={data.imgdata} alt={data.price}/></div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td className='prdct-qty-container'>
                                                            ...
                                                            <button className='prdct-qty-btn' type='button' onClick={data.qnty <=1 ? ()=>handleDecrement(data.id) :()=>handleSingleDecrement(data)}><i className='fa fa-minus'></i>
                                                            </button>
